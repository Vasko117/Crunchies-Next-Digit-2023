  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-t from-[#FFD600] to-[#ff5100]  inset-0 z-[-10] absolute flex justify-normal pl-[3vw] overflow-auto hide-scrollbar">
      <div className="flex justify-center sm:flex-row md:flex-col lg:flex-col mt-[12vh] bg-slate-100 w-[220px] rounded-3xl bg-opacity-25 mr-[5vw] h-max">
        <button className=" bg-white rounded-3xl h-[110px] w-[180px] ml-[2vh] m-[1vh] mt-[3vh] bg-opacity-10 hover:bg-red-600 hover:opacity-80 flex justify-center shadow-lg">
          <Image
            alt="comboIcon"
      ...
      <div className="flex flex-row items-center w-full">
        <div className="mt-[20vh] bg-slate-100 h-full rounded-3xl bg-opacity-25 overflow-auto hide-scrollbar">
          ...
          <div className="flex flex-row flex-wrap justify-center  font-['Rowdies'] text-white overflow-auto hide-scrollbar  ">
            {items.map((food) => (
              <div
                key={food.id}
                className=" w-[16vw] h-max flex flex-col justify-center items-center p-[3vh] text-center rounded-2xl drop-shadow-xl"
              >
                <Image
                  height={100}
                  width={100}
                ...
                <div className="flex flex-col justify-center items-center  bg-opacity-20 w-full break-words">
                  ...
                  <div className="flex flex-row w-full rounded-bl-2xl rounded-br-2xl">
                    <button className="  bg-orange-400 hover:opacity-50 hover:bg-orange-500 w-1/3 p-2   ">
                      -
                    </button>
                    <div className=" bg-white bg-opacity-25  w-1/3 flex items-center justify-center">
                      <p>{food.price}</p>
                    </div>
                    <button className=" bg-green-600 hover:opacity-80 hover:bg-green-600 w-1/3 p-2 ">
                      +
                    </button>
                  </div>
                  <button className="bg-red-500 hover:opacity-80 hover:bg-red-500 w-full rounded-b-2xl p-2 ">
                    Add to cart
                  </button>
                </div>
              </div>
