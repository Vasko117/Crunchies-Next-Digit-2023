		...
		<div className="w-[100vw] h-[100vh] bg-gradient-to-t from-[#FFD600] to-[#ff3c00] -z-10 absolute">
			<div className="flex items-center h-full">
				<div className="w-[50vw] flex flex-col items-center justify-center">
					<p className="text-center text-white text-[80px] font-bold font-['Rowdies'] leading-[5rem] drop-shadow-md">
						Your Taste Buds’ <br /> Second Home
					</p>
					<p className="text-center text-white text-[30px] font-bold font-['Pacifico'] leading-[84.50px] drop-shadow-md">
